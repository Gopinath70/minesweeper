...
int total_mines = 0;
int mines = 0;
int minefield[16][16];                                      //This 2-D array contains all of the mines, numbers and blank spaces
int blank_minefield[16][16];                                //This contains the minefield full of '|-|' characters
int final_minefield[16][16];
